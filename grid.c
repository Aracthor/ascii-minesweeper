...
bool
get_arg(char *arg, struct s_grid *grid)
{
...
bool
create_grid(int argc, char **argv, struct s_grid *grid)
{
    int	i;
    int	j;
    bool valid = true;
...
void
insert_mines(struct s_grid *grid, coord *select)
{
    coord	point;
    int	i;
...
void
destroy_grid(struct s_grid *grid)
{
    int	i;
