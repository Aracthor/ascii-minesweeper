...
static char	*suppr_color(char *data, int *pc)
{
  data[(*pc)++] = '\033';
  data[(*pc)++] = '[';
  data[(*pc)++] = '0';
...
static char	*insert_bold(char *data, int *pc)
{
  data[(*pc)++] = '\033';
  data[(*pc)++] = '[';
  data[(*pc)++] = '1';
...
static char	*insert_background(char *data, int *pc, enum e_color color)
{
  data[(*pc)++] = '\033';
  data[(*pc)++] = '[';
  data[(*pc)++] = '4';
...
static char	*insert_color(char *data, int *pc, enum e_color color)
{
  data[(*pc)++] = '\033';
  data[(*pc)++] = '[';
  data[(*pc)++] = '3';
...
static char	*insert_char_color(char *data, int *pc, char c)
{
...
static char	*border_line(struct s_grid *grid, char *data, int *pc)
{
  int		i;
...
static char	*game_line(struct s_grid *grid, char *data, int *pc, int line,
			   coord *select)
{
  int		i;
...
static char	*center_line(struct s_grid *grid, char *data, int *pc)
{
  int		i;
...
char	*write_game_data(struct s_grid *grid, char *display, int *pc)
{
...
void	print_display(struct s_grid *grid, char *display, coord *select)
{
  coord	moove;
  int   pc = 0;
  int   i;
